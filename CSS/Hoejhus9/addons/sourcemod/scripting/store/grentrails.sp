...
public GrenadeTrails_Config(&Handle:kv, itemid)
{
	...
	KvGetString(kv, "color", g_eGrenadeTrails[g_iGrenadeTrails][szColor], 16, "255 255 255");
	...
	if(FileExists(g_eGrenadeTrails[g_iGrenadeTrails][szMaterial]) || FileExists(g_eGrenadeTrails[g_iGrenadeTrails][szMaterial], true))
	{
		++g_iGrenadeTrails;
		return true;
	}
